...
class ModelConfig:
    ...
    # Архитектура
    vocab_size = 2000  # Размер словаря для мультиязычной токенизации (адаптирован для тестовых данных)
    ...
    use_gradient_checkpointing = False  # Градиентный чекпоинтинг (отключен для совместимости)
